...
from widgets import SearchLineEdit, SortFilterProxyModel, BoardNotification
from workers import DBWorker, UpgradeTimer
from common.common import create_logger
from setting import SerialsUrls, ConfigsProgram
...
class SystemTrayIcon(QtGui.QSystemTrayIcon):
    ...
    def build_menu(self):
        ...
        self.a_exit = menu.addAction('Выйти', app.exit)
...
class MainWindow(QtGui.QMainWindow):
    ...
    def __init__(self, logger: logging.Logger):
        ...
        self.db_worker = DBWorker(self.s_send_db_task)
